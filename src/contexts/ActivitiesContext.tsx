...
export const initialActivities: Activity[] = [
  {
    ...
    description: 'Won First Place at Georgia Tennis State Championships Singles in Athens',
    category: 'Athletics',
  },
  {
    ...
    description: 'Outreach officer for Johns Creek FBLA, managed social media and marketing',
    category: 'Clubs',
  },
  {
